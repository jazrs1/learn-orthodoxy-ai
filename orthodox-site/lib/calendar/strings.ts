...
export const CALENDAR_STRINGS = {
  ...
  ar: {
    ...
    saintInIndex: "اقرأ السيرة",
    attributionTitle: "المصادر",
    attributionDates:
      "حُسبت التواريخ بحسب قواعد التقويم القبطي، وقوبلت بتقويم مطرانية الأقباط الأرثوذكس بجنوب الولايات المتحدة.",
