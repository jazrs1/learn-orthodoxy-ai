...
"sub_queries": if broad is true, 2 to 4 short search queries that together cover the request, each about one aspect the user actually named or implied; do not introduce new topics; otherwise [].
